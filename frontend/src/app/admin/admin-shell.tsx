...
const NAV = [
  ...
  { href: "/admin/bookings",       label: "Rezervasyon Arşivi", icon: "📦" },
  ...
  { href: "/admin/iletisim",       label: "İletişim",        icon: "✉️" },
  { href: "/admin/cuzdan",         label: "İlan Hakkı Arşivi", icon: "🎟️" },
      ...
      <aside className="w-64 shrink-0 flex flex-col py-8 px-4 border-r border-border-soft">
        ...
        <div className="mt-6 pt-6 border-t border-border-soft px-3">
          ...
          <div className="flex items-center justify-between">
            <button onClick={handleLogout} className="text-xs font-bold text-danger hover:underline">
              Güvenli Çıkış
            </button>
            <ThemeToggle />
          </div>
