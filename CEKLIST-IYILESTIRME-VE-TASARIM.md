...
**Tarih:** 9 Eylül 2026. **Durum:** Kullanıcının otonom uygulama talimatıyla yürütülüyor; kanıtlanan işler aşağıda işaretlenir. **Kapsam:** 15 faz, 145 görev, 88 kaynak sayfası.

Kaynaklar: [güncel durum raporu](DURUM-RAPORU-2026-09-09.md), [tasarım yönergesi](TASARIM-YONERGESI-2026-09-09.md), [88 sayfalık kaynak envanteri](SAYFA-ENVANTERI-2026-09-09.csv), [tarayıcı kanıtları](output/playwright/paketjet-2026-09-09/browser-observations.json).
...
- [x] F00-01 Mevcut kirli çalışma ağacını ve canlı HEAD/build/PM2 durumunu yeniden kaydet; başkasının değişikliğini karıştırmayan çalışma alanı oluştur. Kabul: başlangıç diff'i ve kapsam listesi kayıtlı.
  - Kanıt: 2026-09-09 | yayın adayı | route-audit.json, restore-test.txt, başlangıç özel diff | yerel/izole test; canlı kapısı F14.
...
- [x] F01-01 Public ilan DTO'sunu açık alan listesiyle kur; `carrier_name`, özel iletişim, IP ve özel kullanıcı alanlarını çıkar. Kabul: anonim liste/detay/önbellek yanıtında özel bilgi yok; TypeScript Public/Owner/Reveal tipleri ayrılmış.
  - Kanıt: 2026-09-09 | yayın adayı | bundle-auth-audit.json, account-exposure-audit.json, auth-session-test.log, backend-tests-final.log | yerel/izole test; canlı kapısı F14.
...
- [x] F02-01 Etkin sağlayıcıyı gerçek yapılandırmadan belirle; tek sağlayıcı hedefi/uyumluluk dönemini kaydet. Kabul: ürün seçeneği, ayar ekranı, callback ve doküman aynı kararı izler.
  - Kanıt: 2026-09-09 | yayın adayı | ODEME-VE-ESKI-MODEL-KARARLARI.md, backend-tests-final.log, buyer-e2e.json, interaction-tests.json | yerel/izole test; canlı kapısı F14.
...
- [x] F03-01 23 kullanıcı/16 ilan/5 pending ödeme/11 cüzdan başlangıcını güncel, salt okunur envanterle yenile. Kabul: test/gerçek/belirsiz sınıflaması; alan adına bakarak kesin silme yok.
  - Kanıt: 2026-09-09 | yayın adayı | live-inventory.json, backend-tests-final.log, e2e-results.json | yerel/izole test; canlı kapısı F14.
...
- [x] F03-04 Süre bitişini sorgu kuralı ve gerekiyorsa sunucuda çalışan görevle uygula. Kabul: cron çalışmasa bile geçmiş ilan satın alınamaz; scheduler varsa host/timezone/log kanıtı var.
  - Kanıt: 2026-09-09 | yayın adayı | live-inventory.json, backend-tests-final.log, e2e-results.json | yerel/izole test; canlı kapısı F14.
- [ ] F03-05 14 geçmiş aktif ve 2 geçmiş bekleyen ilanı envantere göre düzenle/arşivle. Kabul: güncel liste/ana sayfa/admin sayaçları tutarlı; kişisel erişim geçmişi kaybolmaz.
...
- [x] F04-01 Bookings, booking-messages, ratings, subscription, carrier-agreements ve wallet için kullanım haritası çıkar. Kabul: canlı tüketici, ortak helper ve korunacak callback belli; toplu klasör silme yok.
  - Kanıt: 2026-09-09 | yayın adayı | unused-frontend-files.json, ODEME-VE-ESKI-MODEL-KARARLARI.md, üç build çıktısı | yerel/izole test; canlı kapısı F14.
...
- [x] F05-01 Marka/renk/ikon/font envanterini çıkar; adminin farklı renk ailesi ve alternatif logolarını ortak yönde birleştir. Kabul: logo değişmeden public/panel/admin akraba görünür.
  - Kanıt: 2026-09-09 | yayın adayı | TASARIM-KARSILASTIRMA-2026-09-09.md, visual-matrix.json, final-browser.json | yerel/izole test; canlı kapısı F14.
...
- [x] F06-01 İlk açılış videosunu ana içeriği kapatmayan isteğe bağlı gösterime çevir veya kaldır. Kabul: ilk ziyarette kullanıcı beklemeden arama yapar; video hata verirse ekran kilitlenmez.
  - Kanıt: 2026-09-09 | yayın adayı | home-390/1440-light/dark.png, interaction-tests.json, 057/060/062 migration | yerel/izole test; canlı kapısı F14.
...
- [x] F07-01 İl seçimini semantik ve klavyeyle kullanılabilir combobox yap. Kabul: Türkçe arama, oklar/Enter/Escape, seçili değer/odak ve ekran okuyucu durumu çalışır.
  - Kanıt: 2026-09-09 | yayın adayı | visual-matrix.json, buyer-e2e.json, interaction-tests.json, backend-tests-final.log | yerel/izole test; canlı kapısı F14.
...
- [x] F08-01 Giriş/kayıt/şifre ekranlarını ortak logo/form kabuğuna geçir. Kabul: tek tip etiket, boşluk, düğme ve hata dili; demo erişim yok.
  - Kanıt: 2026-09-09 | yayın adayı | e2e-results.json, auth-session-test.log, password-reset.test.ts, interaction-tests.json, final-browser.json | yerel/izole test; canlı kapısı F14.
...
- [x] F09-01 Büyük gradyanlı/pill menüleri sade sidebar ve mobil menüyle yenile. Kabul: ortak logo/ikon/boyut, aktif bağlantı görünür; tüm işler mobilde erişilebilir.
  - Kanıt: 2026-09-09 | yayın adayı | visual-matrix.json, buyer-e2e.json, interaction-tests.json, final-browser.json | yerel/izole test; canlı kapısı F14.
...
- [x] F10-01 Menü gruplarını görev odaklı sadeleştir; kullanıcılar ve finansı ayır. Kabul: masaüstü/mobil menü, rol görünürlüğü ve gerçek route'lar eşleşir.
  - Kanıt: 2026-09-09 | yayın adayı | final-browser.json, backend-tests-final.log, admin-build-final.log, content-revisions.test.ts | yerel/izole test; canlı kapısı F14.
...
- [x] F11-01 Tüm kamu/panel/admin metinlerini taşıyıcı ilanı → gönderici iletişim satın alımı modeline eşitle. Kabul: llms, hero, adımlar, giriş, destek, e-posta ve metadata çelişmez.
  - Kanıt: 2026-09-09 | yayın adayı | route-audit.json, README.md, 057/061/062 migration, frontend-build-final.log | yerel/izole test; canlı kapısı F14.
...
- [x] F12-01 Frontend'in 9 başlangıç tsc hatasını yaşayan akış testleriyle çöz. Kabul: booking/wallet testleri ya doğru yeni hedefe taşınmış ya kullanım kanıtıyla emekli; kritik kapsam eksilmemiş.
  - Kanıt: 2026-09-09 | yayın adayı | backend-tests-final.log (86), auth-session-test.log (1), frontend-tests-final.log (13), üç build ve tarayıcı JSON | yerel/izole test; canlı kapısı F14.
...
- [x] F12-08 Her yeni ekranı seçilen konseptle aynı viewport'ta görüntüleyip karşılaştır. Kabul: tipografi/boşluk/renk/ikon/hiyerarşi/mobil sıra için fark kaydı ve kapanış kanıtı.
  - Kanıt: 2026-09-09 | yayın adayı | backend-tests-final.log (86), auth-session-test.log (1), frontend-tests-final.log (13), üç build ve tarayıcı JSON | yerel/izole test; canlı kapısı F14.
- [ ] F12-09 Yavaş ağ, API 401/403/404/429/500, boş veri, uzun metin ve sağlayıcı hata durumlarını dene. Kabul: hata “0 kayıt” veya sahte başarıya dönüşmez; geri dönüş/tekrar dene çalışır.
- [ ] F12-10 Performans başlangıcı ve sonunu aynı koşulda ölç. Kabul: video/harita yükü ve layout shift iyileşmiş; hedef LCP≤2,5 sn, INP≤200 ms, CLS≤0,1 için ölçüm yöntemi kaydedilmiş; laboratuvar sonucu saha metriği diye sunulmaz.
...
- [x] F13-01 DB ve gerekli upload/konfigürasyon yedeğinin yerini, erişimini ve saklama politikasını doğrula. Kabul: yedek dosyası yanında izole geri yükleme testi ve tarihli kanıt.
  - Kanıt: 2026-09-09 | yayın adayı | restore-test.txt, upload-restore.txt, source-restore.json, backup-script-test.txt, ISLETIM-VE-YAYIN-2026-09-09.md | yerel/izole test; canlı kapısı F14.
...
- [ ] F13-07 Scheduler/cron, logrotate ve disk izlemeyi gerçek host üzerinde doğrula. Kabul: ilan süre işi varsa son çalışma/timezone ve başarısızlık alarmı kayıtlı; yerel oturuma bağlı değil.
...
- [ ] F14-01 Yayın adayı diff, test sonuçları, migration etkisi ve geri dönüş komutlarını tek pakette hazırla. Kabul: incelenebilir somut sürüm; mevcut kullanıcı değişiklikleri kapsam dışına karışmamış.
- [ ] F14-02 Yayın kapsamı içinde commit/push ve dağıtımı tamamla; canlı commit/build/PM2 eşleşmesini kaydet. Kabul: eski iki yerel düzeltmenin yeni sürümde bulunduğu doğrulanmış.
- [ ] F14-03 Canlı ana sayfa/liste/detay/login/admin/API ve üç 404 örneğini tekrar ölç. Kabul: doğru HTTP, doğru güncel içerik ve beklenen auth davranışı.
- [ ] F14-04 Canlı masaüstü/mobil görsel turu ve tanımlı kontrollü işlem testini tamamla. Kabul: özel verisiz ekran kanıtı; test işlemi mutabık; yeni UI gerçek akışla çalışıyor.
...
- [ ] F14-06 Bu çeklisti, durum raporunu, eski görev bağlantılarını ve deploy bekleyen notunu gerçek sonuca göre güncelle. Kabul: kod/test/canlı durumu ayrı; açık P0/P1 ve kanıtsız tamamlanma yok.
