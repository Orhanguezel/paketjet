...
export async function middleware(req: NextRequest) {
  ...
  response.headers.set('Content-Security-Policy',[
    ...
    "frame-src 'self' https://*.iyzipay.com https://*.iyzico.com https://www.paytr.com https://www.google.com https://accounts.google.com https://www.youtube.com",
  ...
  try {
    ...
    if(user.status===401){const url=new URL(login,req.url);url.searchParams.set('next',req.nextUrl.pathname+req.nextUrl.search);return NextResponse.redirect(url);}
