# CLAUDE.md - PaketJet Admin Panel

Bu dosya, PaketJet `admin_panel` icin calisirken izlenecek guncel gelistirme kurallarini ve proje standartlarini toplar.
...
Bu proje PaketJet admin panelidir.
...
- Bu dokuman sadece mevcut PaketJet yapisini anlatir.
