...
Bu dosya PaketJet `admin_panel` icin zorunlu gelistirme kurallarini tanimlar. Yeni modül, endpoint, page, component veya helper eklenirken bu kurallara uyulmasi gerekir.
